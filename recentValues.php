        ...
        <div class="navbar-header">
          ...
          <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <?php if($marca==true){?>
              <li class="active"><a href="recentValues.php"><i class="icon-th icon-white"></i>Recent Values</a></li>
  ...
  <div id="footerwrap">
    ...
    $('#grafico').highcharts({
        ...
        series: [{
            ...
            //data: document.getElementById("humedadS").value
            data: hs
        }, {
            name: 'Temperatura (°C)',
            //data: [-0.9, 0.6, 3.5, 8.4, 13.5, 17.0, 18.6, 17.9, 14.3, 9.0, 3.9, 1.0]
            //data: document.getElementById("temperatura").value
            data: t
        }, {
            name: 'Luminosidad (%)',
            //data: [3.9, 4.2, 5.7, 8.5, 11.9, 15.2, 17.0, 16.6, 14.2, 10.3, 6.6, 4.8]
            //data: document.getElementById("luminosidad").value
            data: l
        }]
    });
}
