...
<script type="text/javascript" charset="utf-8">
  ...
  <script type="text/javascript">
    function resultados()
        {
          var fechaInicio1=document.getElementById("fechaIn2").value;
        ...
        xmlHttp.onreadystatechange=function(){
            ...
            xmlHttp.open("GET","resultados.php"+"?fecha1="+fechaInicio1+"&fecha2="+fechaFin1,true);//db.php se encarga de leer los mensajes
          xmlHttp.send(null);
  ...
  <body>
	...
	<div class="row">
      ...
      <h4><strong>Lecturas Recientes</strong></h4>
        <table class="display">
            <thead>
              <tr>
                <th>Fecha y Hora</th>
    ...
    <h4><strong>Resumen</strong></h4>
        ...
        Fecha Fin:<input type="date" name="fechaInicio" id="fechaFi1">&nbsp;&nbsp;<button onclick="">Buscar</button><br><br>
        <table class="display">
            <thead>
              <tr>
                <th>Metrica</th>
      ...
      <br><br>
	     Fecha Inicio:<input type="date" name="fechaInicio2" id="fechaIn2">&nbsp;&nbsp;&nbsp;
       Fecha Fin:<input type="date" name="fechaFin2" id="fechaFi2">&nbsp;&nbsp;<button onclick="resultados()">Buscar</button>
       <div id="grafico"></div>
		</div><!--/span12 -->
      </div><!-- /row -->
     </div> <!-- /container -->
